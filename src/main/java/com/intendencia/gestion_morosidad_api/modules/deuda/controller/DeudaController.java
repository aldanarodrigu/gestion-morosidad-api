...
import com.intendencia.gestion_morosidad_api.modules.deuda.dto.ActualizarEstadoRequest;
...
public class DeudaController {
     ...
     * Ejemplo: /api/deudas?estado=PENDIENTE&contribuyente=perez&localidad=libertad&segmento=2&sort=importe,desc&page=0&size=20
     */
    @GetMapping("/deudas")
    ...
    @GetMapping("/deudas/{id}/tributos")
    @PreAuthorize("hasAnyRole('ADMINISTRADOR', 'NOTIFICADOR', 'ANALISTA')")
    public List<TributoResponse> listarTributos(@PathVariable Long id) {
        return deudaService.listarTributos(id);
    }
